...
<h3>Select way of Payment</h3>
 ...
 <option value="Cash on dilvery(COD)">Cash on dilvery(COD)</option>
...
<button class="button" type="submit">Procedd to Generate Bill & Save <i class='far fa-arrow-alt-circle-right'></i></button>
